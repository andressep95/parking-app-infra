...
echo ""
echo "Próximos pasos:"
echo "  1. Destruir el OIDC bootstrap Terraform existente (si existe):"
echo "     cd infrastructure/iam-oidc-legacy && terraform destroy"
echo "  2. Desplegar el bootstrap stack CloudFormation (una sola vez, manual):"
echo "     aws cloudformation deploy \\"
echo "       --template-file infrastructure/cloudformation/github-oidc.yaml \\"
echo "       --stack-name parking-app-github-oidc \\"
